...
Get-ChildItem -Path "C:\Users\$($aAdmin)\Planview, Inc\E1 Build Cutover - Customer Builds\1_FolderTemplate\18" -Filter "InPlace*" | Copy-Item -Destination "C:\Users\$($aAdmin)\Desktop"

...
Get-ChildItem -Path "C:\Users\$($aAdmin)\Planview, Inc\E1 Build Cutover - Customer Builds\1_FolderTemplate\18" -Filter "NewLogo_Upgrade*" | Copy-Item -Destination "C:\Users\$($aAdmin)\Desktop"

...
Get-ChildItem -Path "C:\Users\$($aAdmin)\Planview, Inc\Planview, Inc\E1 Build Cutover - Documents\Customer Builds\1_FolderTemplate\18" -Filter "NewLogo_Upgrade*" | Copy-Item -Destination "C:\Users\$($aAdmin)\Desktop"

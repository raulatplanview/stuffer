...
<# TO 'Logic' #>
. "$($stufferDirectory)\Logic\US-EU Array.ps1" $environments $ad_server $dataCenterLocation $reportFarm $f5ip $f5Credentials $vSphereCredentials $vSphereServer $aAdmin